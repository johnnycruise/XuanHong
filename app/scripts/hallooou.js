...
$(function () {
    $("li[data-content='article']").click(function () {
        $("#news-modal").modal();
        $("#news-modal .modal-services-content").load($(this).attr("data-href"), function (res, status, xhr) {
            setTimeout(function () {
                imgLoad();
            }, 500);
        });
...
//  img lazy
function imgLoad(className) {
    $((className || "img.lazy")).lazyload({
        effect: "fadeIn"
    });
}
$(function () {
